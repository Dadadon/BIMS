    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div class="bg-gray-900 px-6 py-5 text-white">
            <div class="flex justify-between items-start">
                <div>
                    <h2 class="text-lg font-bold"><span class="text-indigo-400">B</span>IMS Payslip</h2>
                    <p class="text-gray-400 text-sm mt-1">{{ $slip->payrollRun->payPeriod->label }}</p>
                </div>
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-100 text-xs text-gray-400 text-center">
            Generated by BIMS · {{ now()->format('F j, Y') }}
        </div>
    </div>
</div>
@endsection
